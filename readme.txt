-----------------------------------------------------------------------------------------------------------
--
-- Copyright 2020 - Pixblasters.com
-- All rights reserved - Sva prava pridržana  
--
-----------------------------------------------------------------------------------------------------------
-- Pixblasters_Light:APA102 Demo is free software distributed under the terms of the GNU General Public License:
...
The Pixblasters Light APA102 Demo is a derivative work from the the Pixblasters MS1 project promoted through the
...
The Pixblasters Light APA102 Demo demonstrates some of the Pixblasters MS1 LED controller's features.

KEY IP CORE DESCRIPTION:
------------------------

The pixblaster_light_apa102 is a key IP core for high-capacity LED controllers. The IP captures video from the 
...
adapted for use with third-party Xilinx FPGA based boards. The supported Pixblasters_Light Demo features:  
  ...
  - LED driving capacity - 8192 RGB APA102, HD107S, SK9822 and compatible LEDs
...
The pixblasters_light_apa102 IP Core does not support all features implemented in the Pixblasters MS1 video LED 
...
three VHDL generics:
 ...
 4. TRAILER defines the length of the End of Frame (TRAILER * 32 clocks)
 5. BRIGTH global brightness level; 31 is the brightest!
 6. DIVIDE_CLK sets up LED_CLK. Valid values 0-3; Default value 1 => 12MHz SPI intf.
	                                          -- 0 => 24 MHz
											  -- 1 => 12 MHz
											  -- 2 =>  6 MHz
											  -- 3 =>  3 MHz
